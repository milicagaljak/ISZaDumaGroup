...
\begin{itemize}
    \item Kratak opis: 
    \begin{itemize}
        \item Zaposleni u firmi se registruje popunjavanjem osnovnih podataka. Sistem izvršava validaciju i vraća potvrdu o registraciji, ukoliko je uspešna.
    \end{itemize}
    \item Učesnici:
        \begin{itemize}
    ...
    \item Preduslovi:
        \begin{itemize}
            \item Osoba je zaposlena u firmi
            \item Zaposleni ima pristup internetu
            \item Sistem je u funkciji
        \end{itemize}
    \item Postuslovi:
        \begin{itemize}
            \item Zaposleni je registrovan ili nije i dobija informaciju o tome
        \end{itemize}
    \item Glavni tok:
        \begin{enumerate}
            ...
            \item Sistem obaveštava korisnika da je 
        \end{enumerate}
