...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{Veronika/Dijagram slucaja upotrebe _ Prenosivi bar.jpg}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{odabir_ponude_fotografija.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=8cm]{Milica/Ketering_Slucaj_upotrebe.jpg}
    \caption{Dijagram slučaja upotrebe Naručivanje keteringa}
    \label{fig:Ketering}
\end{figure}

\subsubsection{Prihvatanje porudžbine za događaj i formiranje tima za događaj}
\begin{itemize}
    \item Kratak opis:
    \begin{itemize}
        \item 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{Milica/Diajgram_Aktivnosti_Sastav_tima.jpg}
    \caption{Dijagram aktivnosti Prihvatanje ponude i formiranje tima }
    \label{fig:RegistracijaZ}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{Milica/Dijagarm_aktivnosti_Priprema_hrane.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{Milica/Dijagram_aktivnosti_Dostava_ketering.jpg}
