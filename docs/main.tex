...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm, height=7cm]{Nina/DijagramAktivnostiRegistracijaZaposlenog.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=10cm, height=5cm]{Nina/Dijagram_aktivnosti_brisanje_naloga.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{Veronika/Dijagram slucaja upotrebe PB.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{Veronika/Dijagram aktivnosti 2 PB.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{Veronika/Dijagram aktivnosti 3 PB.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm]{Veronika/Dijagram aktivnosti 4 PB.jpg}
...
\begin{itemize}
    ...
    \item Glavni tok:
        \begin{enumerate}
            ...
            \item Klijent ima uvid u ukupnu cenu usluge, koja je bila ažurirana tokom vršenja usluge.
            \item Klijent klikom da dugme 'plati' dobija formular koji popunjava podacima koji nedostaju kako bi izvršio uplatu.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=14cm, height=10cm]{dijagram_komponenti.png}
...
Nakon što se klijent prijavio, na ekranu će mu biti prikazana strana \ref{fig:ki_profil} na kojoj se nalaze informacije o korisniku koje je naveo pri registraciji i slika koju može da promeni. Takođe, klikom na neko od dugmića \say{Ketering},  \say{Fotografija} ili \say{Prenosivi bar} korisnik može da odabere uslugu za koju je zainteresovan. Na profilu se nalazi i ukupno zaduženje za usluge koje je klijent odabrao, kao i link \say{PLATI} ka stranici za izmirivanje tog zaduženja.
