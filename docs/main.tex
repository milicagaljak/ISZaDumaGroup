...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm]{baza/dijagram_tabela.jpg}
...
\subsubsection{Izvedeni entiteti}
...
\begin{itemize}
    ...
    \item broj\_kartice - broj kartice klijenta pomoću kog će izvršiti plačanje
    \item datum\_rođenja
    \item pol\_osobe
\end{itemize}
...
Kako bi se pojednostavilo rukovanje bazom podataka, uveden je i pogled Plaćanje.
