...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{Dijagram slucaja upotrebe _ Prenosivi bar.jpg}
...
\begin{itemize}
    ...
    \item Preduslovi:
        \begin{itemize}
            \item Osoba koju administrator pokušava da registruje je prošla konkurs za zapošljavanje u firmi
            \item Sistem je u funkciji
        \end{itemize}
    \item Postuslovi:
        \begin{itemize}
