...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm, height=5cm]{Nina/Slucaj upotrebe rad sa zaposlenima.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=12cm, height=9cm]{Nina/DijagramAktivnostiRegistracijaZaposlenoga.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=13cm, height=6cm]{Andjela/fotografija_dijagram1.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=13cm, height=6cm]{Andjela/odabir_ponude_fotografija.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
    \centering
\includegraphics[width=13cm, height=6cm]{Andjela/fotografisanje.png}
...
\begin{itemize}
    ...
    \item Glavni tok:
        ...
        \begin{figure}[H]
    \centering
\includegraphics[width=13cm, height=6cm]{Andjela/postprodukcija.png}
